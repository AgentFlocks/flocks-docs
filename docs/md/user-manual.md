...
4. [模型配置](#四模型配置)
5. [通信与远程部署](#五通信与远程部署)
6. [通道配置（飞书 / 企微 / 微信 / WhatsApp / 钉钉 / Telegram / 邮件网关）](#六通道配置)
7. [运维与排障](#七运维与排障)
8. [升级方式](#八升级方式)
9. [安全与规范](#九安全与规范)
10. [场景演示](#十场景演示)
...
当前支持：**飞书 / 企业微信 / 微信 / WhatsApp / 钉钉 / Telegram / 邮件网关**。

### 6.1 使用场景

- 研判结果主动推送至企微 / 微信 / WhatsApp / 钉钉 / Telegram 会话或邮箱
...
Agent 或 Workflow 分析
    ↓
通过企微 / 微信 / WhatsApp / 钉钉 / Telegram / 邮件网关等通道发送结果
```
...
| `channels` | 消息通道 | 接飞书 / 企微 / 钉钉 / Telegram / WhatsApp / 邮件网关 |
...
| **Channel** | 把消息送到飞书 / 企微 / 钉钉 / Telegram / WhatsApp / 邮箱等外部触点的能力 |
