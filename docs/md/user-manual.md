...
4. [模型配置](#四模型配置)
5. [通信与远程部署](#五通信与远程部署)
6. [通道配置（飞书 / 企微 / 微信 / WhatsApp / 钉钉 / Telegram）](#六通道配置)
7. [运维与排障](#七运维与排障)
8. [升级方式](#八升级方式)
9. [安全与规范](#九安全与规范)
10. [场景演示](#十场景演示)
...
当前支持：**飞书 / 企业微信 / 微信 / WhatsApp / 钉钉 / Telegram**。

### 6.1 使用场景

- 研判结果主动推送至企微 / 微信 / WhatsApp / 钉钉 / Telegram 会话
- 机器人在特定群或会话中接收消息
- 定时任务结果推送给值班或运营团队
...
Agent 或 Workflow 分析
    ↓
通过企微 / 微信 / WhatsApp / 钉钉 / Telegram 等通道发送结果
```
...
| `channels` | 消息通道 | 接飞书 / 企微 / 钉钉 / Telegram / WhatsApp |
...
| **Channel** | 把消息送到飞书 / 企微 / 钉钉 / Telegram / WhatsApp 等外部触点的能力 |
