...
> 安装启动与首次配置不再重复展开，统一放在 [Quick Start](/md/quick-start)，本页保留可离线导航与核心场景回执。
...
- 安装、启动、模型配置入口： [Quick Start](/md/quick-start)
- 访问控制与远程部署说明： [部署与配置](/md/communication)
- 运维与问题排查： [运维与排障](/md/operations)

### 2.2 任务优先级建议

- 第一次接触：先看 [推荐路径与安装要求](/md/quick-start#安装与快速开始)
- 本机交互优先：按 [Quick Start](/md/quick-start) 的一行命令路径
- 服务器/标准化部署：优先看 [Quick Start](/md/quick-start) 中的 Docker 路径
