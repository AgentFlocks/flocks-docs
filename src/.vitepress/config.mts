      ...
      '/md/': [
          ...
          items: [
            ...
            { text: '3.2 离线安装', link: '/md/communication-network-install' },
            {
              ...
              items: [
                ...
                { text: '3.3.4 Slack 配置', link: '/md/channels/slack' },
                { text: '3.3.5 Telegram 配置', link: '/md/channels/telegram' },
                { text: '3.3.6 微信配置', link: '/md/channels/weixin' },
                { text: '3.3.7 WhatsApp 配置', link: '/md/channels/whatsapp' },
                { text: '3.3.8 邮件网关配置', link: '/md/channels/email' },
              ],
            },
            {
              text: '3.4 模型配置',
            ...
            { text: '3.8 Docker 浏览器配置', link: '/md/communication-docker-browser' },
          ],
        },
        {
          text: '4. 功能模块',
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: '4.8.4 OneSIG 接入', link: '/md/modules/devices/onesig-integration' },
                { text: '4.8.5 NGTIP 接入', link: '/md/modules/devices/ngtip-integration' },
                { text: '4.8.6 天眼接入', link: '/md/modules/devices/skyeye-integration' },
                { text: '4.8.7 深信服 SIP 接入', link: '/md/modules/devices/sangfor-sip-integration' },
              ],
            },
        ...
        },
        {
          ...
          items: [
            ...
            { text: '5.2 SOC 工作区场景套件', link: '/md/scenarios/soc-workspace-suite' },
            {
              text: '5.3 告警降噪',
              link: '/md/scenarios/alert-noise-reduction',
              collapsed: true,
              items: [
                { text: '5.3.1 实时 NDR 降噪工作流', link: '/md/scenarios/stream-ndr-alert-denoise' },
              ],
            },
            {
              text: '5.4 告警研判',
              ...
              collapsed: true,
              items: [
                { text: '5.4.1 批量NDR研判工作流', link: '/md/scenarios/batch-scheduled-ndr-triage' },
              ],
            },
            { text: '5.5 主机巡检 / 应急取证', link: '/md/scenarios/host-forensics' },
            { text: '5.6 设备接入与巡检', link: '/md/scenarios/device-inspection' },
            ...
            { text: '5.10 内网 IP 资产画像', link: '/md/scenarios/ip-profiling' },
            { text: '5.11 漏洞资产排查', link: '/md/scenarios/vuln-asset-matching' },
            { text: '5.12 漏洞验证复现', link: '/md/scenarios/vuln-verification' },
          ],
        },
        {
          text: '6. 运维与排障',
