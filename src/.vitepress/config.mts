    ...
    sidebar: {
      '/md/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '会话管理', link: '/md/modules#会话管理' },
            { text: 'Agent 智能体', link: '/md/modules#agent-智能体' },
            { text: 'Workflow 工作流', link: '/md/modules#workflow-工作流' },
            { text: '任务中心', link: '/md/modules#任务中心' },
            { text: 'Workspace', link: '/md/modules#workspace' },
            { text: '工具清单 / MCP', link: '/md/modules#工具清单-mcp' },
            { text: '模型清单', link: '/md/modules#模型清单' },
            { text: 'Skills 技能库', link: '/md/modules#skills-技能库' },
            { text: '权限与监控', link: '/md/modules#权限与监控' },
          ],
        },
        {
          text: '模型与接入',
