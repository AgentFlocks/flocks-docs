      ...
      '/md/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '5.5 设备接入与巡检', link: '/md/scenarios/device-inspection' },
            { text: '5.6 威胁情报与 IOC 研判', link: '/md/scenarios/threat-intel' },
            { text: '5.7 互联网资产测绘', link: '/md/scenarios/asset-discovery' },
            { text: '5.8 跨设备深度调查', link: '/md/scenarios/cross-device-investigation' },
            { text: '5.9 内网 IP 资产画像', link: '/md/scenarios/ip-profiling' },
            { text: '5.10 漏洞资产排查', link: '/md/scenarios/vuln-asset-matching' },
            { text: '5.11 漏洞验证复现', link: '/md/scenarios/vuln-verification' },
          ],
        },
        {
          text: '6. 运维与排障',
